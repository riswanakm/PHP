...
?>
		...
		<tr>
	    	...
	    	<?php
			    foreach($_SESSION['cart'] as $isbn => $qty){
					...
					$book = mysqli_fetch_assoc($connection ->getBookByIsbn($isbn));
			?>
		<tr>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" name="zipcode" class="col-md-4" class="form-control">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="country" class="control-label col-md-4"></label>
			<div class="col-md-6">
